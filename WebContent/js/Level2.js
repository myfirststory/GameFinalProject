...
Level2.prototype.create = function() {
	...
	this.game.physics.startSystem(Phaser.Physics.ARCADE);
		this.music=this.add.sound("stage2",1,true);
		this.music.play();
	...
	this.map = this.game.add.tilemap("govrntown");
	 this.map.addTilesetImage('stage2');
	 this.map_layer1 = this.map.createLayer("floor");
	 this.map_layer1.resizeWorld();
	 this.map_layer2 = this.map.createLayer("build");
    ...
    die = this.add.image(this.game.width/2, this.game.height/2,"cut2");
	//die.alpha = 0.85;
...
Level2.prototype.addPortal = function(x,y) 
{
...
Level2.prototype.addPlayer = function(x,y) {
	var t = this.add.sprite(x,y-75,"chart");
	...
	Level2.prototype.addCat = function(x,y) {
		...
		Level2.prototype.createWeaponEnemy = function(enemy) {  
		...
		Level2.prototype.onCollide = function(enemies,bullet){  
			...
			exp.animations.add("all").play(16,false,true);
			 ...
			 Level2.prototype.onCollidePortal = function(player,portal){  
					this.music.stop();
			 ...
			 Level2.prototype.enemyFires = function() {	
			 ...
			 Level2.prototype.onPlayerKilled = function(){  
				 ...
				 Level2.prototype.onPlayerCollide = function(enemy,player){ 
					 enemy.damage(1);  
					 return true; } 
				 ...
				 Level2.prototype.inputDown = function(){
					...
					Level2.prototype.killIntro = function() {
						this.killed=true;
